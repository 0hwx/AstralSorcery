...
// }
// }
// throw new ASMTransformationException("Couldn't find method Instruction: owner=" + owner + " nameDeobf=" + nameDeobf +
/// " nameObf=" + nameObf + " signature=" + sig);
// }
//
// @Nonnull
// public static MethodInsnNode getFirstMethodCall(MethodNode mn, String owner, String nameDeobf, String nameObf, String
/// sig) {
// return getNthMethodCallAfter(mn, owner, nameDeobf, nameObf, sig, 0, 0);
// }
//
// @Nonnull
// public static MethodInsnNode getNthMethodCall(MethodNode mn, String owner, String nameDeobf, String nameObf, String
/// sig, int n) {
