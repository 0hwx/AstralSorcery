...
/// "(Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/block/state/Block;)Lnet/minecraft/block/state/Block;");
...
// mn.instructions.insertBefore(prev, new FieldInsnNode(Opcodes.GETSTATIC, "net/minecraftforge/common/MinecraftForge",
...
/// "(Lnet/minecraft/world/chunk/Chunk;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/block/state/Block;Lnet/minecraft/block/state/Block;)V",
/// false));
// mn.instructions.insertBefore(prev, new MethodInsnNode(Opcodes.INVOKEVIRTUAL,
