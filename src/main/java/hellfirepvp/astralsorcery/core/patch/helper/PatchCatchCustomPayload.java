...
// //AbstractInsnNode aisn = findFirstInstruction(mn, Opcodes.ALOAD); //Skip the first few setup label things, however
/// still be before everything.
// MethodNode mn = getMethod(cn, "handleCustomPayload", "func_147240_a",
/// "(Lnet/minecraft/network/play/server/SPacketCustomPayload;)V");
...
// mn.instructions.insertBefore(asisn, new MethodInsnNode(Opcodes.INVOKESTATIC,
/// "hellfirepvp/astralsorcery/common/event/listener/EventHandlerNetwork", "clientCatchWorldHandlerPayload",
/// "(Lnet/minecraft/network/play/server/SPacketCustomPayload;)V", false));
// //mn.instructions.insert(asisn, new MethodInsnNode(Opcodes.INVOKESTATIC,
/// "hellfirepvp/astralsorcery/common/event/listener/EventHandlerNetwork", "clientCatchWorldHandlerPayload",
/// "(Lnet/minecraft/network/play/server/SPacketCustomPayload;)V", false));
// }
//
