...
// mn.instructions.insertBefore(n, new FieldInsnNode(Opcodes.GETSTATIC, "net/minecraftforge/common/MinecraftForge",
/// "EVENT_BUS", "Lnet/minecraftforge/fml/common/eventhandler/EventBus;"));
// mn.instructions.insertBefore(n, new TypeInsnNode(Opcodes.NEW,
/// "hellfirepvp/astralsorcery/common/event/EntityKnockbackEvent"));
...
// mn.instructions.insertBefore(n, new MethodInsnNode(Opcodes.INVOKESPECIAL,
