...
// FMLLog.info("[AstralTransformer] Transforming " + obfName + " : " + transformedClassName + " with " + patches.size()
/// + " patches!");
// try {
...
// }
// } catch (Exception exc) {
// throw new ASMTransformationException("Applying ClassPatches failed (ClassName: " + obfName + " - " +
/// transformedClassName + ") - Rethrowing exception!", exc);
// }
// }
