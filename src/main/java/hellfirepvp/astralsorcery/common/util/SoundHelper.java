...
//    }
    ...
    public static void playSoundAround(ResourceLocation sound, World world, Vector3 position, float volume, float pitch) {
...
//    }
    ...
    public static void playSoundAround(ResourceLocation sound, World world, double posX, double posY, double posZ, float volume, float pitch) {
...
//        }
    ...
    public static PositionedLoopSound playSoundLoopClient(ResourceLocation sound, Vector3 pos, float volume, float pitch, PositionedLoopSound.ActivityFunction func) {
//        if(sound instanceof SoundUtils.CategorizedSoundEvent) {
