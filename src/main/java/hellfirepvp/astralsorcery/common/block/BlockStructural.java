...
public class BlockStructural extends BlockContainer implements BlockCustomName {
    ...
    public boolean addDestroyEffects(World world, int x, int y, int z, int meta, EffectRenderer effectRenderer) {
        ...
        switch (type) {
            case TELESCOPE_STRUCT:
                BlockType.TELESCOPE_STRUCT.getblock()
                    .addDestroyEffects(world, pos.getX(), pos.getY(), pos.getZ(), meta, effectRenderer);
                return true;
            // case ATTUNEMENT_ALTAR_STRUCT:
    ...
    public boolean onBlockActivated(World worldIn, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        switch (type) {
            case TELESCOPE_STRUCT:
                return BlockType.TELESCOPE_STRUCT.getblock()
                    .onBlockActivated(worldIn, pos.getX(), pos.getY(), pos.getZ(), player, side, hitX, hitY, hitZ);
            // case ATTUNEMENT_ALTAR_STRUCT:
            // return BlockType.ATTUNEMENT_ALTAR_STRUCT.getblock().getBlock().onBlockActivated(worldIn, pos.down(),
            // BlockType.ATTUNEMENT_ALTAR_STRUCT.getblock(), playerIn, hand, heldItem, side, hitX, hitY, hitZ);
        }
    ...
    public float getExplosionResistance(Entity par1Entity, World world, int x, int y, int z, double explosionX,
        ...
        switch (type) {
            case TELESCOPE_STRUCT:
                return BlockType.TELESCOPE_STRUCT.getblock()
                    .getBlockHardness(world, pos.getX(), pos.getY(), pos.getZ());
            // case ATTUNEMENT_ALTAR_STRUCT:
    ...
    public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z, EntityPlayer player) {
        ...
        switch (type) {
            ...
            // case ATTUNEMENT_ALTAR_STRUCT:
            // return
            // BlockType.ATTUNEMENT_ALTAR_STRUCT.getblock().getBlock().getPickBlock(BlockType.ATTUNEMENT_ALTAR_STRUCT.getblock(),
            // target, world, pos.down(), player);
        }
    ...
    public boolean isSideSolid(IBlockAccess world, int x, int y, int z, ForgeDirection side) {
        ...
        switch (type) {
            case TELESCOPE_STRUCT:
                return BlockType.TELESCOPE_STRUCT.getblock()
                    .isSideSolid(world, pos.getX(), pos.getY(), pos.getZ(), side);
            // case ATTUNEMENT_ALTAR_STRUCT:
