...
public class BlockCustomOre extends Block implements BlockCustomName, BlockVariants {
    ...
    public void breakBlock(World worldIn, int x, int y, int z, Block blockBroken, int meta) {
        ...
        if (blockBroken.equals(OreType.STARMETAL)) {
            ...
            ((RockCrystalBuffer) WorldCacheManager.getOrLoadData(worldIn, WorldCacheManager.SaveKey.ROCK_CRYSTAL))
                .removeOre(pos);
        }
    }
        ...
        switch (type) {
            case ROCK_CRYSTAL:
                if (world != null && world instanceof World
                    && checkSafety((World) world, pos)
                    && securityCheck((World) world, pos, harvesters.get())) {
