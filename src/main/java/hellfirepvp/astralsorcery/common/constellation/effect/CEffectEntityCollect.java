...
public abstract class CEffectEntityCollect<T extends Entity> extends ConstellationEffect {
    ...
    public CEffectEntityCollect(@Nullable ILocatable origin, IWeakConstellation constellation, String cfgName, double defaultRange, Class<T> entityClass, IEntitySelector filter) {
    ...
    public List<T> collectEntities(World world, BlockPos pos) {
        ...
        return world.selectEntitiesWithinAABB(classToSearch, baseBoundingBox.get(getClass()).offset(pos.getX(), pos.getY(), pos.getZ()).expand(range, range, range), searchFilter);
    }
    ...
    public void loadFromConfig(Configuration cfg) {
        ...
        baseBoundingBox.put(getClass(),  AxisAlignedBB.getBoundingBox(0, 0, 0, 1, 1, 1).expand(range, range, range));
    }
