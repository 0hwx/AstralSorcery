...
// super(origin, Constellations.evorsio, "evorsio", searchRange, 2, (w, pos) -> isAllowedToBreak(origin, w, pos), (pos)
/// -> null);
// }
//
...
/// blocks) in which the ritual will search for blocks to break.");
