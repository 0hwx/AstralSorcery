...
public class GeneralConfig extends ConfigEntry {
    ...
    public void loadFromConfig(Configuration cfg) {
        ...
        giveJournalOnJoin = cfg.getBoolean(
            "giveJournalOnJoin",
            getConfigurationSection(),
            true,
        ...
        // .comment("If set to 'true' anything that prevents mobspawning !by this mod!, will also prevent EVERY natural
        // mobspawning of any mobtype. When set to 'false' it'll only stop monsters of type 'MONSTER' from spawning.")
